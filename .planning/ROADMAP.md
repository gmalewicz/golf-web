...
Angular SPA for managing golf competitions â€” player registration, round recording, handicap tracking (WHS), online real-time scorecards, and multi-season cycle (league) standings with configurable Grand Prix point tables.

## Milestone cycle-2026: 2026 Season Rules

### Phases

- [x] **Phase 1: Cycle 2026** â€” Add CycleDetails2026Component with 2026 Grand Prix points scale and tie-break logic
- [x] **Phase 2: Add Cycle Validation** â€” Update AddCycleComponent validator to accept version = 2

### Phase Details

### Phase 1: Cycle 2026

**Goal:** Add support for the 2026 season rules in cycle (league) standings â€” new component, updated points scale, tie-break algorithm, and routing.
**Requirements**: TBD
