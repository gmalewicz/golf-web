    ...
    if (req.url.endsWith('rest/Holes/1') && (req.method === 'GET')) {
      ...
      return new Observable(observer => {
        ...
        observer.complete();
               ...
               req.url.endsWith('rest/GetSocialPlayer') ||
               req.url.endsWith('rest/Authenticate')) {
      return new Observable(observer => {
        observer.next(new HttpResponse<Array<unknown>>({body:
      ...
      return new Observable(observer => {
        ...
        observer.complete();
               ...
               (req.url.endsWith('rest/ScoreCard/1/1')) ||
               ...
               (req.url.endsWith('rest/DeletePlayerEmail')) ||
               (req.url.startsWith('rest/SearchForPlayer'))
               ) {
      return new Observable (observer => {
