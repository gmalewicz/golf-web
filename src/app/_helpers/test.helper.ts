...
export function getTestRound(): Round {
  ...
  return {
    ...
    }, roundDate: '10/10/2020', format: Format.STROKE_PLAY, mpFormat: 0.75, id: 1,
     player: [{id: 1, nick: 'test', roundDetails: {whs: 10, cr: 68, sr: 133, teeId: 0, teeType: teeTypes.TEE_TYPE_18, team: 1}},
              {id: 2, nick: 'test2', roundDetails: {whs: 10, cr: 68, sr: 133, teeId: 0, teeType: teeTypes.TEE_TYPE_18, team: 1}},
              {id: 3, nick: 'test3', roundDetails: {whs: 10, cr: 68, sr: 133, teeId: 0, teeType: teeTypes.TEE_TYPE_18, team: 2}},
              {id: 4, nick: 'test2', roundDetails: {whs: 10, cr: 68, sr: 133, teeId: 0, teeType: teeTypes.TEE_TYPE_18, team: 2}}],
...
export const authenticationServiceStub : Partial<AuthenticationService> = {
  ...
  get currentPlayer()  { return of({nick: 'test', id: 1, whs: 10})},
